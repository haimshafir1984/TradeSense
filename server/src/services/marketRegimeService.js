...
const STRATEGY_REGIME_FIT_MATRIX = {
  ...
  swing_momentum: {
    bullish: ['high', 'גבוהה', 'שוק שורי תומך היטב בפריצות מומנטום ובגאפים על קטליזטור.'],
    sideways: ['medium', 'בינונית', 'שוק צדדי דורש סלקטיביות גבוהה בבחירת פריצות ופיבוטים.'],
    volatile: ['medium', 'בינונית', 'תנודתיות יכולה להזין מהלכים חדים, אך מעלה גם את הסיכון לשבירות שווא.'],
    bearish: ['low', 'נמוכה', 'שוק דובי מקשה על פריצות והמשכיות מומנטום.'],
    unknown: ['medium', 'בינונית', 'אין מספיק נתונים כדי להעריך התאמה מלאה.']
  },
  small_cap_breakout: {
    bullish: ['high', 'גבוהה', 'שוק שורי מזין תיאבון לסיכון ותומך בפריצות של מניות קטנות.'],
    sideways: ['low', 'נמוכה', 'שוק צדדי גורם לפריצות של מניות קטנות להיכשל בתדירות גבוהה.'],
    volatile: ['medium', 'בינונית', 'תנודתיות יכולה להזין מהלכים חדים, אך מעלה גם את הסיכון לשבירות שווא.'],
    bearish: ['low', 'נמוכה', 'שוק דובי מקשה במיוחד על מניות קטנות ותנודתיות.'],
    unknown: ['medium', 'בינונית', 'אין מספיק נתונים כדי להעריך התאמה מלאה.']
  }
};
